        ...
        <div class="jumbotron">
            ...
            <?php
                if(isset($stuLogEmail)){
                    $sql = "SELECT co.order_id, c.course_id, c.course_name, c.course_duration, c.course_desc, c.course_img, c.course_author, c.course_original_price, c.course_price FROM courseorder AS co JOIN course AS c ON c.course_id = co.ccourse_id WHERE co.stu_email = '$stuLogEmail'";
                    ...
                    if($result->num_rows > 0){
                        ...
                        <div class="bg-light mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <img src="<?php echo $row['course_img']; ?>" class="card-image-top mt-4" alt="pic">
                                </div>

                                <div class="col-sm-6 mb-3">
                                    <div class="card-body">
                                        <p class="card-title"><?php echo $row['course_desc']; ?></p>
                                        <small class="cardtext">Duration: <?php echo $row['course_duration']; ?></small><br/>
