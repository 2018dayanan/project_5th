        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <form id="stuRegForm">
                ...
                <i class="fas fa-envelope"></i><label for="stuemail" class="pl-2 font-weight-bold">Email</label>
                    <input type="text" class="form-control" id="stuemail" name="stuemail" placeholder="Email">
            ...
            <span id="successMsg">
                ...
                <button type="button" class="btn btn-primary" onclick="addStu()" id="stuRegbtn" value="submit">Sign Up</button>
